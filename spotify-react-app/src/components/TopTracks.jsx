...
function TopTracks() {
  ...
  useEffect(() => {
    async function fetchTopTracks() {
      setLoading(true);
      try {
        const data = await spotifyApi(`/me/top/tracks?limit=10&time_range=${timeRange}`);
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem' }}>
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: timeRange === 'short_term' ? '#1DB954' : '#e0e0e0',
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: timeRange === 'medium_term' ? '#1DB954' : '#e0e0e0',
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: timeRange === 'long_term' ? '#1DB954' : '#e0e0e0',
